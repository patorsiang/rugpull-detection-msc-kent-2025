...
def train_model(request: TrainRequest):
    try:
        ...
        print(f"\n[INFO] Starting extracting control flow graph feature session")
        ...
        print(f"\n[INFO] Starting extracting transaction graph feature session")
        ...
        print(f"\n[INFO] Starting extracting transaction feature session")
        save_txn_feature_dataframe(LABELED_PATH)
        log_memory("After transaction feature extraction")
